...
int main (){
    ...
    //WHILE LOOPS
        ...
        //CURRENCY 1
        while (currency_1 == MAD || currency_1 == EUR || currency_1 == USD)
        {
            printf("Enter your curency?(M for MAD, E for EURO and U for USD)\n");
            scanf("%c",&currency_1);
        }
        //CURRENCY 2
        while (currency_2 == MAD || currency_2 == EUR || currency_2 == USD)
        {
            printf("Enter your desired curency?(M for MAD, E for EURO and U for USD)\n");
            scanf(" %c",&currency_2);
        }
        //AMOUNT
        while (0 < amount <= 1000000000)
        {
            printf("Enter your amount?(Between 0 and 1000000000)\n");
            scanf("%lf",&amount);
        }
